...
class MissionExecutionContext:
    def __init__(
        ...
        wait_callback,
        checkpoint_callback,
        peek_robot_notifications_callback,
        pop_robot_notifications_callback
    ) -> None:
        ...
        self._peek_robot_notifications_callback = peek_robot_notifications_callback
        self._pop_robot_notifications_callback = pop_robot_notifications_callback
    ...
    def peek_robot_notifications(self, topic: str | None = None) -> list[dict[str, Any]]:
        return self._peek_robot_notifications_callback(topic)

    def pop_robot_notifications(self, topic: str | None = None) -> list[dict[str, Any]]:
        return self._pop_robot_notifications_callback(topic)
